...
class CARUNet(Model):
  ...
  def convolution_block_dropblock(self,inputs, filters, size,  activation=True,keep_prob=0.9,block_size=7):
  ...
  def residual_drop_block(self,inputs, filters=16, batch_activate=False,keep_prob=0.9,block_size=7):
  ...
  def RCAB(self,inputs, filters, batch_activate=True,k_size=3, keep_prob=0.9,block_size=7):
