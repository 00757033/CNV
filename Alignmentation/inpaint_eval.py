...
class inpaint():
    ...
    def copy_data(self,disease_folder,input_data,data_groups , output_path , mask_file = 'predict'):
        for layer in data_groups:
            
            input_data_path = input_data + '_' + layer
        
        print(os.path.join(disease_folder,input_data_path ,'predict'),os.path.join(self.output_path,layer,'masks'))    
        shutil.copytree(os.path.join(disease_folder,input_data_path ,'predict'),os.path.join(self.output_path,layer,'masks'))       
