...
if __name__ == '__main__':
    ...
    # feature_del = pd.read_csv('./record/' + disease + '_' + date +'/classification_ROI_del.csv')
    
    # for feature in feature_del['feature']:
    #     if feature in classified_data.columns:
    #         classified_data = classified_data.drop(feature, axis=1)

            
    # print('Removel Correlation Filter Feature :', feature_del['feature'].tolist())
    ...
    for case in cases:
        ...
        for classifier_name, classifier in classifiers.items():
            ...
            if case == 'RFECV' and gridsearch == True: # 使用 Pipeline 將特徵選擇和參數調優過程結合起來
                ...
                cv = StratifiedKFold(n_splits=5, shuffle=True, random_state=31)  #27  47 37 97 6-5 56-10 93 6 31 
                min_features = 20
                if classifier_name == 'CatBoost' or classifier_name == 'AdaBoost'or classifier_name == 'Random Forest':
                    min_features = 20
