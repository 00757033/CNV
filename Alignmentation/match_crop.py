    ...
    def __init__(self,image_path,label_path,output_image_path,output_label_path):
        ...
        for method in self.method_name:
            for data in self.data_list:
                setFolder(os.path.join(self.output_image_path,'crop_'+ method, data))
        ...
        for method in self.methods:
            ...
            for data in self.data_list:
                ...
                if os.path.exists(self.image_path + data + '/'  + patient_id + '_' + eye + '_' + pre_treatment + '.png'):
                    ...
                    cv2.imwrite(self.output_image_path+ output_match_par+ '/' + data + '/' + patient_id + '_' + eye + '_' + pre_treatment + '.png', pre_image)
                    if os.path.exists(self.image_path + data + '/'  + patient_id + '_' + eye + '_' + post_treatment + '.png'):
                        ...
                        if not os.path.exists(self.output_image_path  + output_match_par+ '/' + data ):
                            os.makedirs(self.output_image_path  + output_match_par+ '/' + data )
                        if not os.path.exists(self.output_image_path  + output_match_par+ '/' + data +'_move/'):
                            os.makedirs(self.output_image_path  + output_match_par+ '/' + data +'_move/')
                            

                        cv2.imwrite(self.output_image_path   + output_match_par+ '/' + data + '_move/'  + patient_id + '_' + eye + '_' + post_treatment + '.png', result)
