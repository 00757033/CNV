...
def calculate_best_worst(folder_name, result_path):
    ...
    arr_JI = []
    arr_DC = []
    if os.path.exists(result_path + folder_name +'/result3.txt'):
        os.remove(result_path + folder_name +'/result3.txt')

    f = open(result_path + folder_name +'/result3.txt', 'w')
    ...
    for i in index:
        ...
        img_pred = cv2.imread(result_path + folder_name + '/postcrf/' + i, 0)
